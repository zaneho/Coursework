...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 11, 2016 at 02:02 AM
...
(22, 'pat', 'Pet Home', 'Parakeet Cage Round', 'Parakeet round cage with plastic base, a comfortable habitat for your new found feathered friend.This kit is equipped with perches, feeder and waterer.\r\n \r\nSize:\r\nDiameter 47 x L 70 cm', 'bird', 'cage', 'birdcage_pethome.png', '50.00');
...
INSERT INTO `question` (`qid`, `name`, `email`, `contactno`, `subject`, `message`, `timestamp`) VALUES
(1, 'Mary', 'mary@gmail.com', 12345678, 'Product query', 'I went down to your store but turtle pellet Everyday is out of stock. When will it be restocked?', '2016-02-08 13:37:23'),
(2, 'Pat', 'pat@yahoo.com', 83223456, 'Good customer service', 'I went to the store today 8 Feb and receive good service from your staff named Jimmy.', '2016-02-08 13:39:56');
