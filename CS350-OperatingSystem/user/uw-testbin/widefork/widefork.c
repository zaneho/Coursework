...
//printf("This is childnum,  pid:%d %d \n",childnum,pid);
...
{
  int rval;
//printf("childpid, childnum, rval: %d, %d,%d \n",childpid, childnum,rval);
//int a = waitpid(childpid,&rval,0);
//printf("this is waitpid return:%d \n", a);
//if (a < 0) {
...
//printf("This is WIFEXITED: %d \n", WIFEXITED(rval));
  if (WIFEXITED(rval)) {

//printf("This is WEXITSTATUS(rval), childnum %d %d \n", WEXITSTATUS(rval), childnum);
...
main(int argc, char *argv[])
{
  ...
  putchar('\n');
  pid1 = dofork(1);
//printf("This is pid1:%d \n ",pid1);
  putchar('P');
  putchar('\n');
  pid2 = dofork(2);
 //printf("This is pid2:%d \n ",pid2);
  putchar('P');
  putchar('\n');
  pid3 = dofork(3);
//printf("This is pid3:%d \n ",pid3);
  dowait(pid1,1);
  dowait(pid2,2);
  dowait(pid3,3);
  return(0);
