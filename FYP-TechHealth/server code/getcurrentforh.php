...
$result = $conn->query("select events.eventname, events.datetime, events.location, events.userid from events join helperevent on helperevent.eventname = events.eventname where helperevent.userid = '$userid1' and events.eventstatus = 'Current'"); 
