...
// $eventid = $_GET['eventid']; 
 ...
 $result = $conn->query("select events.eventname, events.datetime, events.location, events.userid from events join joinevent on joinevent.eventname = events.eventname where joinevent.userid = '$userid1' and events.eventstatus = 'Upcoming'"); 
