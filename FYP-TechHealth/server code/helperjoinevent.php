...
$result = $conn->query("INSERT INTO helperevent (eventname, userid) SELECT * FROM (SELECT '$eventname', '$userid1') AS tmp WHERE NOT EXISTS ( SELECT * FROM helperevent WHERE eventname = '$eventname' and userid ='$userid1') LIMIT 1");
